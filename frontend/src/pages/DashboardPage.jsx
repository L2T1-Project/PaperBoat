            ...
            {role === "researcher" ? (
              <div className="mt-2 space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <Link
                    to={`/researchers/${userId}/suggest-paper`}
                    className="inline-block rounded-md border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-100"
                  >
                    Suggest Paper
                  </Link>
          ...
          <section className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
            ...
            <article className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm">
              ...
              <div className="mt-2 flex flex-col gap-2">
                ...
                <Link to="/admin/papers" className="rounded-md border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-100">Go to Add Paper</Link>
                ...
                <Link to="/statistics" className="rounded-md border border-slate-300 bg-white px-3 py-1.5 text-xs font-semibold text-slate-700 hover:bg-slate-100">Go to Statistics</Link>
              </div>
            </article>
          </section>
        ) : null}
